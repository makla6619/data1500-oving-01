...
Ditt brukernavn på Oslomet: makla6619
...
- Ditt svar: BufferedWriter samler mange små skriveoperasjoner i minnet og skriver dem til disk i større I/O-blokker i stedet for en og en. Det reduserer antall dyre disk-operasjoner og gir mye bedre ytelse, som er selve poenget med bufring i I/O.
...
- Ditt svar: ikke-normalisert: 150B per rad * 5M rader = 750 MB. 
...
- Ditt svar: 1M studenter * 100B = 100 MB 1000 kurs * 50B = 50 KB (tilnærmet 0MB) 5M påmeldinger * 8B = 40 MB Totalt ≈ 140 MB, så vi sparer ca. 610 MB
...
- Ditt svar: for HDD: 0,0002 TB25$=0,005 og for SSD: 0,0002 TB100$=0,02$. Fordelen med ekstremt raskt oppslag (1ms vs. hundrevis av ms) gjør at tid/plass trade-off er mer enn verdt det.
